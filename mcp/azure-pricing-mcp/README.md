...
This package is a vendored copy of the Azure Pricing MCP server from
[jonathan-vella/apex-accelerator](https://github.com/jonathan-vella/apex-accelerator/tree/main/tools/mcp-servers/azure-pricing).
It is maintained here as part of this repository, so report issues against
this repo rather than upstream. Original copyright holders are listed in
[LICENSE](LICENSE).
